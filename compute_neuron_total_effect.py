...
def main(folder_name="results/20191114_neuron_intervention/", model_name="distilgpt2"):
    ...
    for path in diffnum_files:
        ...
        # filter
        # temp_df = temp_df.loc[temp_df["base_c1_effect"] >= 1.0]

        temp_df["base_c2_effect"] = (
            temp_df["candidate2_base_prob"] / temp_df["candidate1_base_prob"]
        )
        temp_df["diffnum_total_effect"] = temp_df["alt1_effect"] / temp_df["base_c1_effect"]
        #temp_df["diffnum_total_effect"] = temp_df["base_c1_effect"] / temp_df["alt1_effect"]
        ...
        #    temp_df, "diffnum_total_effect", profession_stereotypicality
        #)
        ...
        diffnum_means.append(temp_df["diffnum_total_effect"].mean())
        # she_means.append(mean_she_total)
        means.append(temp_df["total_effect"].mean())
    ...
    print(
        "The total (diffnum) effect of this model is {:.3f}".format(np.mean(diffnum_means) - 1)
    )
    #print(
