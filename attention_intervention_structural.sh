...
python attention_intervention_structural.py --gpt2-version gpt2-medium --do-filter True --structure simple_agreement --filter-quantile 0.3
...
# python attention_intervention_structural.py --gpt2-version gpt2-medium --do-filter True --structure across_obj_rel_no_that --filter-quantile 0.8
...
# python attention_intervention_structural.py --gpt2-version gpt2-medium --do-filter True --structure within_obj_rel_no_that --filter-quantile 0.6
