...
def get_template_list(structure=None, grammar=None):
    ...
    if structure is None:
        ...
        templates = StrTemplates("The {} that the {} {}", grammar)
...
# get global list 
def get_all_contrib(templates, tokenizer, out_dir='', grammar=None):
...
if __name__ == '__main__':
    ...
    ap.add_argument('--structural', type=bool, default=False)
    ap.add_argument('--grammar_file', type=str, default='structural/grammar.avg')
    ...
    if structural:
        ...
        templates = get_template_list(structure='across_obj_rel', grammar=grammar)
    else:
        grammar = None
    ...
    if args.algo == 'topk':
        ...
        if os.path.exists(marg_contrib_path):
            ...
            layer_list, neuron_list = get_all_contrib(templates, tokenizer, out_dir, grammar=grammar)
        if layer == -1:
